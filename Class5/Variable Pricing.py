...
isVariablePricing = True #Can see the changes if prices are not variable (FALSE)
...
# Try to keep upper and lower bound in the variable definition
p = model.addVars(7, lb=0, ub=40, vtype=GRB.CONTINUOUS, name="Price")
d = model.addVars(7, lb=0, ub=1100, vtype=GRB.CONTINUOUS, name="Daily Demand") #Harder if demand is an integer, will take a long time to converge
