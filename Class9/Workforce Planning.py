...
df_center = pd.read_csv(r"C:\Users\gabri\Downloads\homecare_centers.csv", index_col=0)

# # Read the details associated with each demand
df_demand = pd.read_csv(r"C:\Users\gabri\Downloads\homecare_demands.csv")

# Read the distance between each center and region
df_dist = pd.read_csv(r"C:\Users\gabri\Downloads\homecare_distances.csv")
