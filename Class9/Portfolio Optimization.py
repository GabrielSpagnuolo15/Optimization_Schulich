...
symbols = pd.read_csv(r"C:\Users\gabri\Downloads\symbols.csv")
...
# Comptue the minimum risk of the portfolio as well as the expected return.
# Convert the average daily values into a yearly value and then percentage.
minrisk_volatility = sqrt(model.objval)*sqrt(365)
minrisk_return = (mu @ x_flat)*365*100
...
print("Expected Yearly Return: ", minrisk_return)
print("Expected Yearly Volatility: ", minrisk_volatility)
